...
export * from './exploitant/exploitant-create/exploitant-create.component'
...
export * from './production/production-list.component'
export * from './formation/formation-detail/formation-detail.component'
export * from './formation/formation-list/formation-list.component'
export * from './innovation/innovation-list.component'
